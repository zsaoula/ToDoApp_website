								...
								<tbody>
									...
									<td class="align-middle">
										<a href="#!" class="text-info" data-mdb-toggle="tooltip" title="Edit todo">
                  						...
                  						<a class="text-danger" data-mdb-toggle="tooltip"  href="index.php?action=supprimerTache&idTache=<?php echo $tache->getId();?>" title="Delete todo">
					...
					<div class="card-footer text-end p-3">
						...
						<form class="d-flex flex-row align-items-center" method="post">
                    				...
                    				<div>
										...
										<input type="hidden" name="action" value="ajoutTachePrivee">
				   					</form>
