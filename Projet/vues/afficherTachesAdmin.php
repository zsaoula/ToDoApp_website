<html>
	...
	<body>
						...
						<?php
							...
							<?php
                                    if($_SESSION['role'] === "admin"){ ?>
                                        <li class="nav-item">
                                            <a class="nav-link  text-primary" href="index.php?action=afficherTachesAdmin">Listes Admin</a>
                                        </li>
                            <?php   } ?>
						<?php } ?>
					</ul>
		...
		<?php foreach($listesTachesAdmin as $listes){ ?>
			<section class="t-0">
												...
												<td class="align-middle">
													<?php 
														if(($tache->getChecked()) == 1){
															echo '<input type="checkbox" checked="true" name="tacheAlreadyChecked'. $tache->getId(). '" value="' .$tache->getId(). '"  disabled="disabled"></input>';
														}
														else {
															echo '<input type="checkbox" name="tacheChecked'. $tache->getId(). '" value="' .$tache->getId(). '"  disabled="disabled"></input>';
														}
													?>
												</td>
												<td class="align-middle">
				...
				<div class="popup-content">
					...
					<div>
						<form class="d-flex flex-column" method="post" >
							...
							<input type="hidden" name="action" value="editerTacheAdmin">
						</form>
					</div>
				</div>
			</div>
					...
					<div class="d-flex flex-column pt-2">
						<form  method="post">
							...
							<div class="py-3 pb-0 d-flex justify-content-between">
								...
								<input type="hidden" name="action" value="supprimerListeTacheAdmin">
					...
					<div class="d-flex flex-column pt-2">
						<form  method="post">
							...
							<div class="py-3 pb-0 d-flex justify-content-between">
								...
								<input type="hidden" name="action" value="supprimerTacheAdmin">
								<input type="submit" class="btn btn-primary" value="Confirmer">
							</div>
						</form>
					</div>		
